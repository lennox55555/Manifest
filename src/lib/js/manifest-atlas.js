...
class ManifestAtlas {
	...
	<div style="display: flex; flex-direction: column; align-items: center; width: 100%;">
    	...
    	<div style="display: flex; justify-content: space-between; align-items: center; width: 100%; padding: 5px 0;">
        	...
        	<p style="flex-grow: 1; text-align: center; margin: 0 5px;">From Index: <span style="color: #746F80;">${feature.properties.connections.from.properties.mindex}</span></p>
        	<div style="width: 1.5px; height: 20px; background-color: #746F80;"></div>
        	<p style="flex-grow: 1; text-align: center; margin: 0 5px;">To Index: <span style="color: #746F80;">${feature.properties.connections.to.properties.mindex}</span></p>
